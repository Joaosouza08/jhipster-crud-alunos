...
import com.meusistema.clientes.service.MetaService;
...
/**
 * REST controller for managing {@link com.meusistema.clientes.domain.Meta}.
 */
@RestController
...
public class MetaResource {
    ...
    public ResponseEntity<List<Meta>> getAllMetas(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        Page<Meta> page = metaService.findAll(pageable);
